<div class="py-4">
  <div class="container">
    <div class="standard-cat">
      <ul class="nav justify-content-center">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Shop everything</a>
        </li>
        <li class="nav-item">
    ...
    <div id="buudlCarousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="{{ asset('assets/img/slides/slide2.jpeg') }}" class="d-block w-100 carousel-image" alt="slide_2">
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img src="{{ asset('assets/img/slides/slide3.jpg') }}" class="d-block w-100 carousel-image" alt="slide_3">
          <div class="carousel-caption d-none d-md-block">
  ...
  <livewire:components.landing.topSearches />
  <livewire:components.landing.newArrivals />
</div>
