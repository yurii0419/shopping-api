<div class="py-4">
            ...
            @foreach ($popularItems as $popularItem)
                <div class="swiper-slide p-4">
                    <div class="d-flex flex-column overflow-hidden">
                        <div class="brandImg">
                            <a href="" class="img "><img class="" src="{{ asset('assets/img/brands/'.$popularItem->image) }}" alt=""></a>
                        </div>
    ...
    <div class="container-fluid shopByCategory mt-5">
        ...
        <ul class="listCategory">
            <li><a href="/shop/women" class="link"><span>Women</span><span><i class="fa-solid fa-arrow-right"></i></span></a></li>
            <li><a href="/shop/men" class="link"><span>Men</span><span><i class="fa-solid fa-arrow-right"></i></span></a></li>
            <li><a href="/shop/kids" class="link"><span>Kids</span><span><i class="fa-solid fa-arrow-right"></i></span></a></li>
            <li><a href="/shop/all" class="link active"><span>Everything</span><span><i class="fa-solid fa-arrow-right"></i></span></a></li>
        </ul>
        </div>
    </div>
