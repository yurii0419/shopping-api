                                ...
                                <div class="d-flex flex-column mb-4">
                                    <div class="digit-group">
                                        <input type="number" pattern="[0-9]*" min="0" max="9"
                                            maxlength="1" inputtype="numeric" id="otc-1" wire:model="otc1"
                                            class="codeDanger otpNumber">
                                        <input type="number" pattern="[0-9]*" min="0" max="9"
                                            maxlength="1" inputtype="numeric" id="otc-2" wire:model="otc2"
                                            class="codeDanger otpNumber">
                                        <input type="number" pattern="[0-9]*" min="0" max="9"
                                            maxlength="1" inputtype="numeric" id="otc-3" wire:model="otc3"
                                            class="codeDanger otpNumber">
                                        <input type="number" pattern="[0-9]*" min="0" max="9"
                                            maxlength="1" inputtype="numeric" id="otc-4" wire:model="otc4"
                                            class="codeDanger otpNumber">
                                        <input type="number" pattern="[0-9]*" min="0" max="9"
                                            maxlength="1" inputtype="numeric" id="otc-5" wire:model="otc5"
                                            class="codeDanger otpNumber">
                                        <input type="number" pattern="[0-9]*" min="0" max="9"
                                            maxlength="1" inputtype="numeric" id="otc-6" wire:model="otc6"
                                            class="codeDanger otpNumber">
                                    </div>
                                    @if (session('otp_error'))
                                        <small><span
                        ...
                        @else
                            ...
                            <div class="form-group">
                                <div class="d-flex flex-column mb-2">
                                    <input class="form-control @error('email') is-invalid @enderror" id="email"
                                        name="email" placeholder="Email or Username" type="text"
                                ...
                                <div class="d-block d-sm-flex justify-content-between align-items-center mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="remember_me" name="remember_me" wire:model="remember_me">
                            ...
                            <div class="socialLink">
                                ...
                                <span class="socialLinkButton" id="register-button"><a href="">
                                        <i class="fa-brands fa-google" style="color: blue;"></i><span
                                            id="gText"></span>
                                    </a></span>
                            </div>
