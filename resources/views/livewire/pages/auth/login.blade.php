<section class="d-flex align-items-center" id="loginPage" style="background-image: url({{ asset('assets/img/loginBg.png') }});">
  <div class="container">
    <div class="row justify-content-end">
      <div class="col-12 col-md-8 col-lg-6 justify-content-center">
        <div class="card shadow-soft border-light py-4 px-5 bg-transparent border-0">
          ...
          <div class="card-body pt-0">
            ...
            <div class="form-group">
              <div class="d-flex flex-column mb-4">
                ...
                <div class="d-flex justify-content-between pt-2" x-data="{ countdown: 120, isDisabled: true }" x-init="isDisabled = true;
                                    countdown = 120;
                  ...
                  <button id="resendButton" wire:click.prevent="resendCode" x-show="! isDisabled"> Resend Code</button>
                  ...
                  @endif
                  <button id="resendButton" wire:click.prevent="resendCode" :disabled="isDisabled">Resend Code</button>
                  <span x-show="isDisabled" x-text="'Please wait ' + countdown + ' seconds...'"></span>
                </div>
          ...
          >>>>>>> 7a36e76c992570d747a69d8099514201dba1e053
        </div>
    ...
    <button wire:click.prevent="verifyCode" type="button" class="btn btn-block btn-primary w-100 text-white">
      ...
      <span wire:loading.remove wire:ignore wire:target="verifyCode">Log In</span>
    </button>
    @if (session('message'))
    ...
    <!-- End of Form -->
    <button wire:click.prevent="verifyCode" type="button" class="btn btn-block btn-primary w-100 text-white">
      <span wire:loading wire:ignore wire:target="verifyCode">
        <span class="spinner-border" role="status">
          <span class="visually-hidden"></span>
        </span>
      </span>
