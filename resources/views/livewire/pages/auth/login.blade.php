        ...
        <div class="card shadow-soft border-light py-4 px-5 bg-transparent border-0">
          ...
          <div class="card-body pt-0">
            ...
            <div class="form-group">
              <div class="d-flex flex-column mb-4">
                <div class="digit-group">
                  <input type="number" wire:change="nextInput" pattern="[0-9]*" inputtype="numeric" autocomplete="one-time-code" id="otc-1" wire.model.defer="otc_1" class="codeDanger">
                  <input type="number" pattern="[0-9]*" min="0" max="9" maxlength="1" inputtype="numeric" id="otc-2" wire.model.defer="otc_2" class="codeDanger">
                  <input type="number" pattern="[0-9]*" min="0" max="9" maxlength="1" inputtype="numeric" id="otc-3" wire.model.defer="otc_3" class="codeDanger">
                  <input type="number" pattern="[0-9]*" min="0" max="9" maxlength="1" inputtype="numeric" id="otc-4" wire.model.defer="otc_4" class="codeDanger">
                  <input type="number" pattern="[0-9]*" min="0" max="9" maxlength="1" inputtype="numeric" id="otc-5" wire.model.defer="otc_5" class="codeDanger">
                  <input type="number" pattern="[0-9]*" min="0" max="9" maxlength="1" inputtype="numeric" id="otc-6" wire.model.defer="otc_6" class="codeDanger">
                </div>
                @error('number')
                <small><span class="text-danger error">{{ $message }}</span></small>
                @enderror
