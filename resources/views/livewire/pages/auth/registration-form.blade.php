<div class="signup-container absolute " style="top: 6vh;right:5vw;">
    ...
    <div class="border justify-content-center gap-2 align-items-center d-flex flex-column bg-white p-3">
        ...
        <div class=" w-75 justify-content-center gap-2 align-items-center d-flex flex-column">
            <div class="d-flex">
                <div>
                    <input type="text" wire:model="firstname" class="rounded form-control @error('firstname') is-invalid @enderror" placeHolder="First Name" />

                </div>
                <div>
                    <input type=" text" wire:model="lastname" class="rounded ms-1 form-control @error('lastname') is-invalid @enderror" placeHolder="Last Name" />
        ...
        <div class="text-center text-sm mt-3 mb-3 text-gray-600">
            ...
            <div class="flex gap-2">
                ...
                <button wire:click="increaseStep" class="btn bg-primary p-2 px-5 w-75 h-12 rounded mt-1 text-white color-orange font-semibold"><span wire:target="increaseStep">Next</span>
                    <!-- Loading Spinner -->
                    <span wire:loading>
    ...
    <div class=" justify-content-center gap-2 align-items-center d-flex flex-column bg-white p-3">
        ...
        <div class="text-center text-sm mt-3 mb-3 text-gray-600">
            ...
            <div class="flex gap-2">
                ...
                <button wire:click="increaseStep" class="btn bg-primary p-2 px-5 w-75 h-12 rounded mt-1 text-white color-orange font-semibold">Next<span wire:loading>
                        <span class="spinner-border" role="status">
                            <span class="visually-hidden"></span>
                        </span>
                    </span></button>
    ...
    <div class="  justify-content-center gap-2 align-items-center d-flex flex-column bg-white p-3">
        ...
        <div class="form-group">
            <div class="d-flex flex-column mb-4">
                <div class="digit-group">
                    <input type="number" pattern="[0-9]*" inputtype="numeric" autocomplete="one-time-code" id="otc-1" wire.model.defer="otc_1" class="codeDanger otpNumber">
        ...
        <div class=" justify-content-center gap-2 align-items-center d-flex flex-column bg-white p-3">
            ...
            <div class="text-center text-sm mt-10 text-gray-600">
                <div>
                    <button wire:click="increaseStep" class="btn bg-primary  h-12 rounded mt-1 text-white color-orange font-semibold">Send
                        Code</button>
