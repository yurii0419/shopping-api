            ...
            <div class="col-md-12 card">
                <div class="card-body">
                    <div id="centercontent-wrapper" class="page-content col-md-12 col-lg-9 columnwith-left centerColumn aside">
                        <div id="center-page-content" class="content-indent page-main form-default">
                            <div class="centerColumn" id="privacy">
                                <div class="page-title mb-4">
                                    <h1 id="privacyDefaultHeading">Privacy Policy</h1>
                                </div>
                                <div id="privacyDefaultMainContent" class="content">
                                    ...
                                    <ul>
                                        <li>To improve your site experience and to allow us to deliver the type of content and product offerings in which you are most interested.</li>
                                    ...
                                    <p>How do we protect visitor information?<br>
                                    <br>
                                    ...
                                    <br>
                                    Do we disclose the information we collect to outside parties?<br>
                                    <br>
                                    We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information unless we provide you with advance notice, except as described below. The term "outside parties" does not include&nbsp;<a href="https://www.buudl.com/">www.buudl.com</a>. It also does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or servicing you, so long as those parties agree to keep this information confidential. We may also release your information when we believe release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property, or safety.<br>
                                    <br>
                                    ...
                                    <br>
                                    How can you opt-out, remove or modify information you have provided to us?<br>
                                    <br>
                                    ...
                                    <br>
                                    If we decide to change our privacy policy, we will post those changes on this page. Policy changes will apply only to information collected after the date of the change.&nbsp;This policy was last modified on August 6, 2003.<br>
                                    <br>
