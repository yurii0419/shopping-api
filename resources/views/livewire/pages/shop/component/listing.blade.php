    ...
    <div class="product_sell_listing row">
      <div class="col-lg-3">
        <div class="items position-relative">
          ...
          <img class="img img-fluid" src="{{ asset('assets/img/profile_listing/item1.png') }}" alt="" style="object-fit: contain;">
      ...
      <div class="col-lg-3">
        <div class="items position-relative">
          ...
          <img class="img img-fluid" src="{{ asset('assets/img/profile_listing/item2.png') }}" alt="" style="object-fit: contain;">
          <div class="item_description pt-3">
            <h4>Beach Polo</h4>
            <h4>P 300</h4>
          </div>
      ...
      <div class="col-lg-3">
        <div class="items position-relative">
          ...
          <img class="img img-fluid" src="{{ asset('assets/img/profile_listing/item3.png') }}" alt="" style="object-fit: contain;">
          <div class="item_description pt-3">
            <h4>Orange Pants</h4>
            <h4>P 600</h4>
          </div>
      ...
      <div class="col-lg-3">
        <div class="items position-relative">
          ...
          <img class="img img-fluid" src="{{ asset('assets/img/profile_listing/item4.png') }}" alt="" style="object-fit: contain;">
          <div class="item_description pt-3">
            <h4>Shiny Tops</h4>
            <h4>P 400</h4>
          </div>
